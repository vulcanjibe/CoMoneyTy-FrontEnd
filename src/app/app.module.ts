...
import {DetailAmi} from "../pages/cmy-detail-ami/cmy-detail-ami";
import {MasterHome} from "../pages/master/master-home";
import {ListeDocument} from "../pages/cmy-liste-document/cmy-liste-document";
import {AjoutDocumentPage} from "../pages/cmy-ajout-document/cmy-ajout-document";
import {ModalOnePhoto} from "../pages/cmy-modal/modal-one-photo";
